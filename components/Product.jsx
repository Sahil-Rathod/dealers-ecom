...
const Product = ({ product }) => {
  ...
  return (
    ...
    >
      <div className="absolute end-4 top-4 rounded-xl border-2 border-black transition  z-50 flex items-center justify-center duration-200 hover:scale-105 px-2 py-1 ">
